export const teamMembers = [
  {
    ...
    journey: [
      ...
      "Certified Orthopedic Manual Therapy (COMT) from Capri Institute",
      "Certification in Neurodevelopmental Therapy (NDT)",
      "Training in Dry Needling & Kinesio Taping",
      "Advanced HVLA Chiropractic Techniques under Dr. Giovanni Bonfanti",
      "Professional practice at Yuvraj Shivraj Singh Neuro Rehab Center, Jodhpur",
      "Chief Physiotherapist at Vasundhara Hospital, Jodhpur"
    ]
  },
  {
    slug: "rubina-pathan",
